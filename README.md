...
- **Nested Object Support**: Automatically flattens nested objects with underscore notation
...
- **Backup Creation**: Safely backup existing .env files before conversion
